...
The system was tested using standard software testing techniques:

White Box Testing – Logic and code-level testing

Black Box Testing – Functional requirement testing

Unit Testing – Individual module testing

Module Testing – Integrated module validation 
